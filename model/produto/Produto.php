...
class Produto extends DB
{
    ...
    public static function get_date($seach)
    {
        try
        {
            ...
            if(!empty($dates)) // encontrou produtos
            {
                return $dates;
            }
            else // não encontrou
    ...
    // Retorna último produto inserido
